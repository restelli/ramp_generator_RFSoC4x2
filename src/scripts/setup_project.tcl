...
create_project Simple_RFSoC /home/fpga/restelli_git/Simple_RFSoC/src/Simple_RFSoC -part xczu48dr-ffvg1517-2-e
...
endgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/zynq_ultra_ps_e_0/M_AXI_HPM0_FPD} Slave {/usp_rf_data_converter_0/s_axi} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
startgroup
set_property -dict [list CONFIG.ADC_RESERVED_1_00 {0} CONFIG.ADC_RESERVED_1_02 {0} CONFIG.ADC_OBS02 {0} CONFIG.DAC0_Enable {1} CONFIG.DAC0_PLL_Enable {true} CONFIG.DAC0_Refclk_Freq {400.000} CONFIG.DAC0_Fabric_Freq {200.000} CONFIG.DAC_Slice00_Enable {true} CONFIG.DAC_Interpolation_Mode00 {2} CONFIG.DAC_Mixer_Type00 {1} CONFIG.DAC_Coarse_Mixer_Freq00 {3} CONFIG.DAC_RESERVED_1_00 {0} CONFIG.DAC_RESERVED_1_01 {0} CONFIG.DAC_RESERVED_1_02 {0} CONFIG.DAC_RESERVED_1_03 {0}] [get_bd_cells usp_rf_data_converter_0]
endgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/zynq_ultra_ps_e_0/pl_clk0 (99 MHz)} Clk_xbar {/zynq_ultra_ps_e_0/pl_clk0 (99 MHz)} Master {/zynq_ultra_ps_e_0/M_AXI_HPM1_FPD} Slave {/usp_rf_data_converter_0/s_axi} ddr_seg {Auto} intc_ip {/ps8_0_axi_periph} master_apm {0}}  [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
apply_bd_automation -rule xilinx.com:bd_rule:rf_converter_usp -config {ADC0_AXIS_SOURCE "Custom" DAC0_AXIS_SOURCE "Custom" }  [get_bd_cells usp_rf_data_converter_0]
startgroup
...
add_files /home/fpga/restelli_git/Simple_RFSoC/src/hdl/rampgen.v
update_compile_order -fileset sources_1
set_property SOURCE_SET sources_1 [get_filesets sim_1]
add_files -fileset sim_1 /home/fpga/restelli_git/Simple_RFSoC/src/sim/rampgen_tb.v
update_compile_order -fileset sim_1
update_compile_order -fileset sim_1
make_wrapper -files [get_files /home/fpga/restelli_git/Simple_RFSoC/src/Simple_RFSoC/Simple_RFSoC.srcs/sources_1/bd/main/main.bd] -top
connect_bd_net [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
connect_bd_net [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
make_wrapper -files [get_files /home/fpga/restelli_git/Simple_RFSoC/src/Simple_RFSoC/Simple_RFSoC.srcs/sources_1/bd/main/main.bd] -top
add_files -norecurse /home/fpga/restelli_git/Simple_RFSoC/src/Simple_RFSoC/Simple_RFSoC.gen/sources_1/bd/main/hdl/main_wrapper.v
update_compile_order -fileset sources_1
update_compile_order -fileset sources_1
